    ...
    product && (
      ...
      >
        <div className='group cursor-pointer flex items-center justify-center px-2'>
          <img
            className='group-hover:scale-105 transition max-w-26 md:max-w-36 max-h-40'
            src={product.image[0]}
            alt={product.name}
          />
        </div>
          ...
          <div className='flex items-end justify-between mt-3'>
            ...
            >
              {!cartItems[product._id] ? (
                ...
                <div className='flex items-center justify-center gap-2 md:w-20 w-16 h-[34px] bg-primary/10  border-primary/40 rounded select-none'>
                  <button
                    onClick={() => {
